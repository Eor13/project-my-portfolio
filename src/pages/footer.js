    ...
    return(
        <footer className="containerFooter">
            <address className="redes">
                ...
                <a className="default" href="https://github.com/Eor13" target="_blank"><FontAwesomeIcon className="icon" icon={faGithubAlt}/></a>
                <a className="default" href="https://www.linkedin.com/in/everson-de-oliveira-ribeiro/" target="_blank"><FontAwesomeIcon className="icon" icon={faLinkedinIn} /></a>
            </address>
