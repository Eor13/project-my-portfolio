...
const Projects =() =>{
    ...
    return(
        <section className="containerProjects">
            <h1>Projetos</h1>
            <p style={{color:theme.color}}>Estes são alguns projetos desenvolvidos onde aplico algumas tecnicas e tecnologias de desenvolvimentos aprendidas durante durente meu aprendizado de programador.</p>
