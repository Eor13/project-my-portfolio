        ...
        <>
            <ContainerAbout>
                ...
                <Description>  
                    ...
                    <Text>🧠Possuo conhecimento em HTML5, CSS3, ECMAscript, React, TypeScript, Context API, Redux, Git , GitHub, Consumo de API, testes automatizados com JEST e deploy de aplicação via Vercel e Github, Java, Spring, Banco de Dados SQL e NoSQL.</Text>
                    ...
                    <Text>🚶‍♂️Estou disposto a aprender linguagens que não estão em meu radar de atenção no atual momento caso necessário.</Text>
